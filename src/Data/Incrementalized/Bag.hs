...
fstF :: forall term e a b. (Diff a, Typeable a, Diff b, Typeable b, App2 IFqS term e) => e (a, b) -> e a
fstF = lift (fstS Proxy Proxy)

sndF :: forall term e a b. (Diff a, Typeable a, Diff b, Typeable b, App2 IFqS term e) => e (a, b) -> e b
