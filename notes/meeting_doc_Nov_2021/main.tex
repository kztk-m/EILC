...
The discussions~\cite{sec:notes-on-function-objects} suggest that it is difficult (at least, far from straightforward) to have a function object (respecting types) 
...
\[
\var{pseudoLam} :: \con{Sem} \A \sem{\Gamma, x : A} \A \sem{B} \to \exists E. \exists C. \con{Sem} \A \sem{\Gamma} \A (\con{Closure} \A E \A C \A A \A B)
\] 
